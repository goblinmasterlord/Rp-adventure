...
export class AntiInjectionFilter {
  ...
  static readonly INJECTION_RESPONSE = {
    ...
    investigation_quality: 'NONE' as const,
    clue_revelation: null,
    current_objective: 'Focus on what lies before you',
    objective_progress: null,
    suggested_actions: ['Look around carefully', 'Try something else'],
    world_reaction: { type: 'NONE' as const, description: null },
    tension_shift: 0,
    item_gained: null,
    item_lost: null,
